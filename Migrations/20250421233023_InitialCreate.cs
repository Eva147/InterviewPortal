    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionTopics", x => new { x.PositionId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_PositionTopics_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PositionTopics_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterviewSessions_PositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PositionTopics_TopicId",
                table: "PositionTopics",
                column: "TopicId");
